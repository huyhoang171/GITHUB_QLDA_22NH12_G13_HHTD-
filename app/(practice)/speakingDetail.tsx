...
const audioFiles: Record<string, any> = {
 ...
 // 'i_am_a_student.mp3': require('../../assets/audio/introductions/i_am_a_student.mp3'),
  ...
  'i_am_25_years_old.mp3': require('../../assets/audio/introductions/i_am_25_years_old.mp3'),
  'i_live_in_hanoi.mp3': require('../../assets/audio/introductions/i_live_in_hanoi.mp3'),
  'i_am_a_software_engineer.mp3': require('../../assets/audio/introductions/i_am_a_software_engineer.mp3'),
  'i_like_reading_books.mp3': require('../../assets/audio/introductions/i_like_reading_books.mp3'),
  'my_favorite_color_is_blue.mp3': require('../../assets/audio/introductions/my_favorite_color_is_blue.mp3'),
  'i_have_two_brothers.mp3': require('../../assets/audio/introductions/i_have_two_brothers.mp3'),
  'i_am_single.mp3': require('../../assets/audio/introductions/i_am_single.mp3'),
  'i_love_playing_football.mp3': require('../../assets/audio/introductions/i_love_playing_football.mp3'),
  'i_can_speak_english_and_vietnamese.mp3': require('../../assets/audio/introductions/i_can_speak_english_and_vietnamese.mp3'),
  'i_graduated_from_university_last_year.mp3': require('../../assets/audio/introductions/i_graduated_from_university_last_year.mp3'),
  'i_am_interested_in_music.mp3': require('../../assets/audio/introductions/i_am_interested_in_music.mp3'),
 ...
 // 'i_am_learning_english.mp3': require('../../assets/audio/introductions/i_am_learning_english.mp3'),
  ...
  'i_am_an_only_child.mp3': require('../../assets/audio/introductions/i_am_an_only_child.mp3'),
  'i_like_watching_movies.mp3': require('../../assets/audio/introductions/i_like_watching_movies.mp3'),
  'i_am_from_ho_chi_minh_city.mp3': require('../../assets/audio/introductions/i_am_from_ho_chi_minh_city.mp3'),
  'i_am_a_doctor.mp3': require('../../assets/audio/introductions/i_am_a_doctor.mp3'),
  'i_have_a_younger_sister.mp3': require('../../assets/audio/introductions/i_have_a_younger_sister.mp3'),
  'i_am_a_graphic_designer.mp3': require('../../assets/audio/introductions/i_am_a_graphic_designer.mp3'),
  'i_love_animals.mp3': require('../../assets/audio/introductions/i_love_animals.mp3'),
  'i_am_a_high_school_student.mp3': require('../../assets/audio/introductions/i_am_a_high_school_student.mp3'),
  'i_like_listening_to_music.mp3': require('../../assets/audio/introductions/i_like_listening_to_music.mp3'),
  'i_am_a_university_student.mp3': require('../../assets/audio/introductions/i_am_a_university_student.mp3'),
  'i_am_from_the_countryside.mp3': require('../../assets/audio/introductions/i_am_from_the_countryside.mp3'),
  'i_am_a_nurse.mp3': require('../../assets/audio/introductions/i_am_a_nurse.mp3'),
  'i_am_30_years_old.mp3': require('../../assets/audio/introductions/i_am_30_years_old.mp3'),
  'i_am_a_tour_guide.mp3': require('../../assets/audio/introductions/i_am_a_tour_guide.mp3'),
  'i_am_a_businesswoman.mp3': require('../../assets/audio/introductions/i_am_a_businesswoman.mp3'),
  'i_am_a_businessman.mp3': require('../../assets/audio/introductions/i_am_a_businessman.mp3'),
  'i_am_a_chef.mp3': require('../../assets/audio/introductions/i_am_a_chef.mp3'),
  'i_am_a_photographer.mp3': require('../../assets/audio/introductions/i_am_a_photographer.mp3'),
  'i_am_a_dancer.mp3': require('../../assets/audio/introductions/i_am_a_dancer.mp3'),
  'i_am_a_singer.mp3': require('../../assets/audio/introductions/i_am_a_singer.mp3'),
  'i_am_a_writer.mp3': require('../../assets/audio/introductions/i_am_a_writer.mp3'),
  'i_am_a_student_at_abc_university.mp3': require('../../assets/audio/introductions/i_am_a_student_at_abc_university.mp3'),
  'i_am_a_new_member_here.mp3': require('../../assets/audio/introductions/i_am_a_new_member_here.mp3'),
  'i_am_happy_to_join_this_group.mp3': require('../../assets/audio/introductions/i_am_happy_to_join_this_group.mp3'),
  'i_am_here_to_learn_english.mp3': require('../../assets/audio/introductions/i_am_here_to_learn_english.mp3'),
  'i_am_excited_to_meet_everyone.mp3': require('../../assets/audio/introductions/i_am_excited_to_meet_everyone.mp3'),
  'i_am_looking_forward_to_working_with_you.mp3': require('../../assets/audio/introductions/i_am_looking_forward_to_working_with_you.mp3'),
  'i_am_glad_to_be_here.mp3': require('../../assets/audio/introductions/i_am_glad_to_be_here.mp3'),
  // Travel
  ...
  'work_11.mp3': require('../../assets/audio/work/work_11.mp3'),
  'work_12.mp3': require('../../assets/audio/work/work_12.mp3'),
  'work_13.mp3': require('../../assets/audio/work/work_13.mp3'),
  'work_14.mp3': require('../../assets/audio/work/work_14.mp3'),
  'work_15.mp3': require('../../assets/audio/work/work_15.mp3'),
  'work_16.mp3': require('../../assets/audio/work/work_16.mp3'),
  'work_17.mp3': require('../../assets/audio/work/work_17.mp3'),
  'work_18.mp3': require('../../assets/audio/work/work_18.mp3'),
  'work_19.mp3': require('../../assets/audio/work/work_19.mp3'),
  'work_20.mp3': require('../../assets/audio/work/work_20.mp3'),
  'work_21.mp3': require('../../assets/audio/work/work_21.mp3'),
  'work_22.mp3': require('../../assets/audio/work/work_22.mp3'),
  'work_23.mp3': require('../../assets/audio/work/work_23.mp3'),
  'work_24.mp3': require('../../assets/audio/work/work_24.mp3'),
  'work_25.mp3': require('../../assets/audio/work/work_25.mp3'),
  'work_26.mp3': require('../../assets/audio/work/work_26.mp3'),
  'work_27.mp3': require('../../assets/audio/work/work_27.mp3'),
  'work_28.mp3': require('../../assets/audio/work/work_28.mp3'),
  'work_29.mp3': require('../../assets/audio/work/work_29.mp3'),
  'work_30.mp3': require('../../assets/audio/work/work_30.mp3'),
  'work_31.mp3': require('../../assets/audio/work/work_31.mp3'),
  'work_32.mp3': require('../../assets/audio/work/work_32.mp3'),
  'work_33.mp3': require('../../assets/audio/work/work_33.mp3'),
  'work_34.mp3': require('../../assets/audio/work/work_34.mp3'),
  'work_35.mp3': require('../../assets/audio/work/work_35.mp3'),
  'work_36.mp3': require('../../assets/audio/work/work_36.mp3'),
  'work_37.mp3': require('../../assets/audio/work/work_37.mp3'),
  'work_38.mp3': require('../../assets/audio/work/work_38.mp3'),
  'work_39.mp3': require('../../assets/audio/work/work_39.mp3'),
  'work_40.mp3': require('../../assets/audio/work/work_40.mp3'),
  'work_41.mp3': require('../../assets/audio/work/work_41.mp3'),
  'work_42.mp3': require('../../assets/audio/work/work_42.mp3'),
  'work_43.mp3': require('../../assets/audio/work/work_43.mp3'),
  'work_44.mp3': require('../../assets/audio/work/work_44.mp3'),
  'work_45.mp3': require('../../assets/audio/work/work_45.mp3'),
  'work_46.mp3': require('../../assets/audio/work/work_46.mp3'),
  'work_47.mp3': require('../../assets/audio/work/work_47.mp3'),
  'work_48.mp3': require('../../assets/audio/work/work_48.mp3'),
  'work_49.mp3': require('../../assets/audio/work/work_49.mp3'),
  'work_50.mp3': require('../../assets/audio/work/work_50.mp3'),
};
